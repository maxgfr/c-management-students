...
{
	Logement l;
	fscanf(flot,"%s",l.idchamb);
	fscanf(flot,"%s",l.idbat);
	fscanf(flot,"%d",&l.etage);
	fscanf(flot,"%d",&l.numchambre);
...
/* 11- FONCTIONS DE TRI DICHOTOMIQUE PAR TYPE ET DISPONIBILITE DE LOGEMENT*/
